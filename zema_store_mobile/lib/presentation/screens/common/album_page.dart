...
import 'package:zema_store_mobile/presentation/screens/common/music_detail_page.dart';


class AlbumPage1 extends StatefulWidget {
  final dynamic song;

  const AlbumPage1({Key? key, this.song}) : super(key: key);
  @override
  _AlbumPageState createState() => _AlbumPageState();
}

class _AlbumPageState extends State<AlbumPage1> {
  @override
